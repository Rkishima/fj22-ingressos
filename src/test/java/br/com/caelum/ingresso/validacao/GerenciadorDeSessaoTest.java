...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes() {
		...
		this.sessaoDasDezoite = new Sessao(LocalTime.parse("18:00:00"), rogueOne, sala3D);
	}

	@Test
	public void garanteQueNaoDevePermitirSessaoNoMesmoHorario() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
		GerenciadorDeSessao gereciador = new GerenciadorDeSessao(sessoes);
		Assert.assertFalse(gereciador.cabe(sessaoDasDez));
	}
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesIniciandoDentroDoHorarioDeUmaSessoJaExistente() {
